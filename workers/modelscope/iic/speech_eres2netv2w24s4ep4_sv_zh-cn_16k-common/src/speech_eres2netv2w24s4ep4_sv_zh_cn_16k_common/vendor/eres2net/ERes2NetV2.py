...
#
# Snapshot source:
#   GPT-SoVITS/GPT_SoVITS/eres2net/ERes2NetV2.py
# Upstream:
#   3D-Speaker — https://github.com/alibaba-damo-academy/3D-Speaker
# GPT-SoVITS usage:
#   sv.py / 2-get-sv.py → forward3() → [B, 20480]
# Pairing:
#   pretrained_eres2netv2w24s4ep4.ckpt
#   ERes2NetV2(baseWidth=24, scale=4, expansion=4)
#
# Do not edit. Numerical parity with GPT-SoVITS v2Pro SV pipeline is required.
# Snapshot: 2026-06-07
# -----------------------------------------------------------------------------
