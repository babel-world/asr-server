# -----------------------------------------------------------------------------
# VENDORED — local SV worker (frozen)
#
# Snapshot source:
#   GPT-SoVITS/GPT_SoVITS/eres2net/kaldi.py
# Upstream:
#   torchaudio Kaldi-compatible fbank
#   (GPT-SoVITS vendors this copy; sv.py imports it as `kaldi`)
# GPT-SoVITS call site:
#   Kaldi.fbank(wav, num_mel_bins=80, sample_frequency=16000, dither=0)
#
# Do not edit. fbank output must match 2-get-sv.py / sv.py exactly.
# Snapshot: 2026-06-07
# -----------------------------------------------------------------------------
