...
#
# Snapshot source:
#   GPT-SoVITS/GPT_SoVITS/eres2net/pooling_layers.py
# Upstream:
#   3D-Speaker — https://github.com/alibaba-damo-academy/3D-Speaker
#   (file note: adapted from wespeaker)
# Dependency:
#   ERes2NetV2.py
#
# Do not edit. Keep identical to GPT-SoVITS copy for weight loading parity.
# Snapshot: 2026-06-07
# -----------------------------------------------------------------------------
